pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE    = 'oldeus/fastapi-webhook:latest' // Ensure this Docker image name is correct and accessible.
        REMOTE_HOST     = 'thanasit_mick@34.143.135.151' // Replace with your actual username and remote IP.
        SSH_CREDENTIALS = 'thanasit' // Use the ID of the Jenkins stored SSH credentials.
    }

    stages {
        stage('Login to Docker Hub') {
            steps {
                // This step logs into Docker Hub using credentials stored in Jenkins. ss
